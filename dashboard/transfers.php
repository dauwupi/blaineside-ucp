...
<script>
  ...
  {
    "key": "submit",
    "label": "Submit an Asset Transfer",
    "what": "Ask for something of yours to be moved to somebody else.",
    "steps": [
      "What is moving, and to whom.",
      "What you are getting for it, if anything.",
      "Confirmation from both sides before it goes anywhere."
    ],
    "after": "Staff check it is really yours and that the other player agreed, then make the move in game."
  },
  {
    "key": "mine",
    "label": "My Asset Transfers",
    "what": "Transfers you have sent or been named in.",
    "steps": [
      "Waiting on the other player, waiting on staff, done, or refused.",
      "What was moved, and when.",
      "Anything a reviewing administrator asked you for."
    ],
    "after": "Both sides see the same record, so neither can claim a different version of it later."
  },
  {
    "key": "panel",
    "label": "Asset Transfer Panel",
    "what": "The transfer queue.",
    "steps": [
      "Check ownership and that both players consented.",
      "Approve and carry out the move, or refuse it with a reason.",
      "Every completed transfer stays attached to both accounts."
    ],
    "after": "Trainee Admin and above, for the same reason as refunds: property changes hands as a result."
  }
];
  ...
  /* The hash IS the view: the sidebar links to /dashboard/transfers#panel, so
  ...
  UCP.get('session.php').then(function(d){
    if(!d || d.authenticated !== true){
      window.location.replace('/login?return='+encodeURIComponent('/dashboard/transfers'));
      return;
    }
