...
.searchbox{display:flex;align-items:center;gap:9px;height:40px;padding:0 14px;flex:1;min-width:200px;
  border-radius:10px;border:1px solid var(--border);background:var(--charcoal);color:var(--text-dim)}
.searchbox svg{width:15px;height:15px;flex:none;stroke-width:2;fill:none;stroke:currentColor}
